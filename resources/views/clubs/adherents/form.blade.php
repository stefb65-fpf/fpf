...
@endif
    ...
    <div class="formBlock">
        ...
        <div class="formBlockWrapper">
            ...
            <div class="formLine">
                ...
                <input class="inputFormAction" id="personneDateNaissance" type="date" value="{{ old('datenaissance', $utilisateur->personne->datenaissance) }}" name="datenaissance" required />
            </div>
        </div>
    </div>
    <div class="formBlock">
        ...
        <div class="formBlockWrapper">
            ...
            <div class="formLine">
                ...
                <input name="codepostal" type="text" id="adresseCodepostal" value="{{ old('codepostal', $utilisateur->personne->adresses[0]->codepostal) }}" class="inputFormAction" maxlength="10" required/>
            </div>
            <div class="formLine">
            ...
            <div class="formLine">
                ...
                <select class="inputFormAction" name="pays" id="selectPays">
        ...
        <div class="formBlockWrapper">
            ...
            <div class="formLine">
                <div class="formLabel">Code Postal *</div>
                <input name="adresse2_codepostal" type="text" value="{{ old('adresse2_codepostal', $utilisateur->personne->adresses[1]->codepostal) }}" class="inputFormAction" maxlength="10" required/>
            </div>
            <div class="formLine">
                <div class="formLabel">Ville *</div>
            ...
            <div class="formLine">
                <div class="formLabel">Pays *</div>
                <select class="inputFormAction" name="adresse2_pays" id="selectPaysAdresse2">
                    @foreach($countries as $country)
    ...
    <div class="formBlock">
        ...
        <div class="formBlockWrapper">
            <div class="formLine">
                <input class="inputFormAction" name="news" type="checkbox" {{ $utilisateur->personne->news === 1 ? 'checked' : '' }} />
