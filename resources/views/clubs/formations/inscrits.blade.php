...
@section('content')
    <div class="pageCanva">
        <h1 class="pageTitle">
            ...
            <a class="previousPage" title="Retour page précédente" href="{{ route('clubs.formations') }}">
        ...
        <div class="d-flex justify-center">
            <a href="{{ route('clubs.inscrits.export', $session) }}" class="btnSmall adminSuccess ml10">exporter au format excel</a>
        </div>
