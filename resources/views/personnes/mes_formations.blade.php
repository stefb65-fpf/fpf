...
@section('contentaccount')
    <div class="accountContent">
        <div class="provisoire mt25"
             style="width: 100%;min-height: 200px; display: flex; justify-content: center;align-items: center; flex-direction: column">
            Bientôt disponible
            <div class="img" style="margin-top: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 2048 2048">
