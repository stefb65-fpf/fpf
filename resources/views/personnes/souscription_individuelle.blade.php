        ...
        <div class="w100">
            ...
            @else
                ...
                <div class="alertInfo w80">
                    <span class="bold">Informations !</span>
                    <div>
                        Vous pouvez souscrire une carte d'adhérent individuel en étant rattaché à l'UR <b>{{ $ur ? $ur->nom : "Région Parisienne (le numéro d'ur sera déterminé après adhésion en fonction de votre adresse exacte)" }}</b>.<br>
