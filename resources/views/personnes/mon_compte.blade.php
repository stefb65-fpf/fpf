...
@section('contentaccount')
    ...
    <div class="accountContent">
        <div class="">
            Pour consulter et renouveler vos adhésions, vous devez vous rendre dans l'onglet <a href="{{ route("adhesion") }}" class="blue bold">"Adhésion"</a> de votre compte.
        </div>
        <div class="">
