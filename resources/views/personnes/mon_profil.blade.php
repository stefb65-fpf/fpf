...
{{--                            <div class="formLineModify">Changement sécurisé</div>--}}
                        ...
                        <div class="formLine">
                            ...
                            <form class="togglingFields" action="{{route('updatePassword',$personne)}}"method="POST">
                                ...
                                <div class="hiddenFields hidden password">
                                    <div class="fields">
                                        <div class="customField">
                                            <div class="group">
                                                <input class="checkableInput original" type="password" name="password" value="{{ old('password', '') }}" placeholder="nouveau mot de passe"/>
                                                <div class="icons eye">
                                                    <div class="icon open">
                                        ...
                                        <div class="customField">
                                            ...
                                            <div class="group">
                                                <input class="checkableInput confirmation" type="password" name="password_confirmation" value="{{ old('password_confirmation', '') }}" placeholder="confirmez">
                                                <div class="icons eye">
                                                    <div class="icon open">
                                                        <svg width="22" height="16" viewBox="0 0 22 16" fill="none"
                                                             xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    <button type="submit" class="formBtn relative d-none success" name="enableBtn" disabled id="resetPasswordBtn">Valider</button>
