...
@section('content')
    <div class="pageCanva">
        <h1 class="pageTitle">
            Ajout d'une élection pour le vote {{ $vote->nom }}
        ...
        <div class="alertInfo w80">
            ...
            Vous allez ajouter une élection. Une fois fait, si votre élection n'est pas une motion, vous pourrez ajouter des cnadidats.
        </div>
        @include('admin.votes.elections_form', ['action' => 'store'])
    </div>
@endsection
@section('css')
