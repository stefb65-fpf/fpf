...
@section('content')
    <div class="pageCanva">
        <h1 class="pageTitle">
            ...
            <a class="previousPage" title="Retour page précédente" href="{{ route('admin.statistiques_votes_phases') }}">
        ...
        @include('admin.statistiques.detail_votes_by_club', ['level' => 'admin'])
    </div>
