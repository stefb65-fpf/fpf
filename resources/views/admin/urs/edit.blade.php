...
@section('content')
    <div class="pageCanva">
        <h1 class="pageTitle">
            Modification des informations de l'UR {{ $ur->nom }}
        ...
        <div class="formBlock">
            ...
            <div class="formBlockWrapper">
                ...
                <form class="w100" action="{{route('urs.update', $ur)}}" method="POST">
                    ...
                    <div class="formBlockWrapper">
                        <div class="formValueGroup">
                            ...
                            <div class="formUnit w100">
                                ...
                                <div class="group">
                                    <div class="indicator {{$ur->adresse && $ur->adresse->indicatif_mobile!==""?"":"d-none"}}">+{{$ur->adresse?$ur->adresse->indicatif_fixe:""}}</div>
                                    <input class="formValue phoneInput modifying" type="text"
