    ...
    <div class="bottom">
        <div class="featuresWrapper">
            ...
            <ul class="menu">
                ...
                <li class="menuItem{{ Request::is('gestion-club')?" active":""}}" data-direction="gestion-club">
                <div class="title">
                    Gestion club
                </div>
                </li>
                <li class="menuItem{{ Request::is('gestion-ur')?" active":""}}" data-direction="gestion-ur" >
                <div class="title">
                    Gestion UR
                </div>
                </li>
                <li class="menuItem{{ Request::is('gestion-fpf')?" active":""}}" data-direction="gestion-fpf" >
                <div class="title">
                    Gestion FPF
                </div>
                </li>
