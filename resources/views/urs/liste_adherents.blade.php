...
@section('content')
    <div class="pageCanva">
        <h1 class="pageTitle">
            Liste des adhérents de l'UR {{ $ur->nom }}
        ...
        <div class="alertDanger w80">
            ...
            <p class="mt20">
                On affiche ici la liste des adhérents de l'UR (clubs et individuels) avec la possibilité de modifier les informations des adhérents
            </p>
        </div>
    </div>
@endsection
