...
@section('content')
    <div class="pageCanva">
        ...
        <div class="formBlock">
            ...
            <form class="w100" action="{{ route('urs.fonctions.attribuate', $fonction) }}" method="POST">
                {{ csrf_field() }}
            ...
            <table class="table styled-table">
                ...
                @foreach($utilisateurs as $utilisateur)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('urs.fonctions.delete_attribution_multiple', [$fonction, $utilisateur]) }}" class="adminDanger btnSmall"
