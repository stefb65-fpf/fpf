            ...
            <div class="formBlockWrapper align-start">
                @if(isset($tab_fonctions[94]))
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.updateFonctionClub',[$club->id,$tab_fonctions[94]->id_utilisateur,94])}}"
                              method="POST">
                        ...
                        <form action="{{route('urs.deleteFonctionClub',[$club->id, $tab_fonctions[94]->id_utilisateur,94])}}"
                              method="POST">
                ...
                @else
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.addFonctionClub',[$club->id, 94])}}" method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
        ...
        <div class="formBlock relative">
            ...
            <div class="formBlockWrapper align-start">
                @if(isset($tab_fonctions[97]))
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.updateFonctionClub',[$club->id,$tab_fonctions[97]->id_utilisateur,97])}}"
                              method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="attention formBtn relative mr25 btnSmall" name="showSelect">changer</button>
                ...
                @else
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.addFonctionClub',[$club->id, 97])}}" method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="success formBtn relative mr25 btnSmall" name="showSelect">Ajouter</button>
                            <select class="formValue adherent modifying floating hidden" name="adherent_id"
        ...
        <div class="formBlock relative">
            ...
            <div class="formBlockWrapper align-start">
                @if(isset($tab_fonctions[95]))
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.updateFonctionClub',[$club->id,$tab_fonctions[95]->id_utilisateur,95])}}"
                              method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="attention formBtn relative mr25 btnSmall" name="showSelect">changer</button>
                        ...
                        <form action="{{route('urs.deleteFonctionClub',[$club->id, $tab_fonctions[95]->id_utilisateur,95])}}"
                              method="POST">
                            <input type="hidden" name="_method" value="delete">
                            {{ csrf_field() }}
                            <button class="danger formBtn relative btnSmall" type="submit">supprimer</button>
                ...
                @else
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.addFonctionClub',[$club->id, 95])}}" method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="success formBtn relative mr25 btnSmall" name="showSelect">Ajouter</button>
                            <select class="formValue adherent modifying floating hidden" name="adherent_id"
        ...
        <div class="formBlock relative">
            ...
            <div class="formBlockWrapper align-start">
                @if(isset($tab_fonctions[96]))
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.updateFonctionClub',[$club->id,$tab_fonctions[96]->id_utilisateur,96])}}"
                              method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="attention formBtn relative mr25 btnSmall" name="showSelect">changer</button>
                        ...
                        <form action="{{route('urs.deleteFonctionClub',[$club->id, $tab_fonctions[96]->id_utilisateur,96])}}"
                              method="POST">
                            <input type="hidden" name="_method" value="delete">
                            {{ csrf_field() }}
                            <button class="danger formBtn relative btnSmall" type="submit">supprimer</button>
                ...
                @else
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.addFonctionClub',[$club->id, 96])}}" method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="success formBtn relative mr25 btnSmall" name="showSelect">Ajouter</button>
                            <select class="formValue adherent modifying floating hidden" name="adherent_id"
        ...
        <div class="formBlock relative">
            ...
            <div class="formBlockWrapper align-start">
                @if(isset($tab_fonctions[320]))
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.updateFonctionClub',[$club->id,$tab_fonctions[320]->id_utilisateur,320])}}"
                              method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="attention formBtn relative mr25 btnSmall" name="showSelect">changer</button>
                        ...
                        <form action="{{route('urs.deleteFonctionClub',[$club->id, $tab_fonctions[320]->id_utilisateur,320])}}"
                              method="POST">
                            <input type="hidden" name="_method" value="delete">
                            {{ csrf_field() }}
                            <button class="danger formBtn relative btnSmall" type="submit">supprimer</button>
                ...
                @else
                    <div class="btnWrapper d-flex relative w100">
                        <form action="{{route('urs.addFonctionClub',[$club->id, 320])}}" method="POST">
                            <input type="hidden" name="_method" value="put">
                            {{ csrf_field() }}
                            <button class="success formBtn relative mr25 btnSmall" name="showSelect">Ajouter</button>
                            <select class="formValue adherent modifying floating hidden" name="adherent_id"
