...
@section('content')
    <div class="pageCanva">
        <h1 class="pageTitle">
            ...
            <a class="previousPage" title="Retour page précédente" href="{{ route('urs.statistiques_vote_detail', [$vote, $club->urs_id]) }}">
        ...
        @include('admin.statistiques.detail_votes_by_adherent', ['level' => 'urs'])
    </div>
@endsection
