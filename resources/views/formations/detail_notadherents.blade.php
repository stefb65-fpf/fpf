...
@section('content')
    <div class="formationsPage pageCanva">
        <h1 class="pageTitle">
            {{ $formation->name }}
            <a class="previousPage" title="Retour page précédente" href="{{ route('formations.notadherents') }}#{{ $formation->id }}">
...
{{--                    Vous disposez d'un avoir de <span class="bold">{{ $personne->avoir_formation }} €</span> sur votre compte.--}}
        ...
        <div class="modalEditFooter">
            ...
            <div data-return="detail_notadherents" class="adminPrimary btnMedium mr10" id="formationPayCb" data-link="" data-ref="">Payer par CB</div>
            <div data-return="detail_notadherents" class="adminPrimary btnMedium mr10 d-none" id="saveFormationWithoutPaiement" data-ref="">Valider mon inscription</div>
        </div>
    </div>
